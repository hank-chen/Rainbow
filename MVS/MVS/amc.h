...
class CAmc : public CWnd
{
protected:
	DECLARE_DYNCREATE(CAmc)
public:
...
//
	...
	void SetAdditionalMediaSource(LPCTSTR theURL, LPCTSTR theMediaUsername, LPCTSTR theMediaPassword, long theIndex, long reserved)
	{
		static BYTE parms[] = VTS_BSTR VTS_BSTR VTS_BSTR VTS_I4 VTS_I4 ;
		InvokeHelper(0x9e, DISPATCH_METHOD, VT_EMPTY, NULL, parms, theURL, theMediaUsername, theMediaPassword, theIndex, reserved);
	}
